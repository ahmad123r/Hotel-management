...
import com.example.hotel_management_application.adapters.RequestedBookingAdapter;
...
public class RequestedBookingActivity extends AppCompatActivity implements BookingViewFetchMessage {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(RequestedBookingActivity.this, UserMenuActivity.class);
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(RequestedBookingActivity.this, UserProfileActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
                finish();
            }
...
//        ListDataView.setLayoutManager(mLayoutManager);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(RequestedBookingActivity.this, HomePageActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(intent);
        finish();
    }
    ...
    public void onUpdateFailure(String message) {
        Toast.makeText(RequestedBookingActivity.this, message, Toast.LENGTH_LONG).show();
