...
public class CurrentBookingActivity extends AppCompatActivity implements BookingViewFetchMessage {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CurrentBookingActivity.this, UserMenuActivity.class);
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CurrentBookingActivity.this, UserProfileActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
                finish();
            }
...
//        ListDataView.setLayoutManager(mLayoutManager);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(CurrentBookingActivity.this, HomePageActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(intent);
        finish();
    }
    ...
    public void onUpdateFailure(String message) {
        Toast.makeText(CurrentBookingActivity.this, message, Toast.LENGTH_LONG).show();
